          ...
          <div class="col-md-12 mb-4 mt-5">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama" class="form-control" placeholder="Product Name" required value="<?php echo $p->product_name?>">
                </div>
                <div class="mb-3">
                    <label class="form-label">Product Price</label>
                    <input type="text" name="harga" class="form-control" placeholder="Product Price" required value="<?php echo $p->product_price?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <textarea class="form-control" name="deskripsi" placeholder="Description" rows="3"><?php echo $p->product_description?></textarea>
                </div>
                <div class="mb-3">
                    <select name="status" class="form-select" required>
                        <option value="">Choose Status</option>
                        <option value="1" <?php echo ($p->product_status == 1)? 'selected':''?>>Ready</option>
                        <option value="0" <?php echo ($p->product_status == 0)? 'selected':''?>>Empty</option>
                    </select>
                </div>
